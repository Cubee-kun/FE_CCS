...
const About = () => {
  ...
  return (
    <>
      <div className="pt-20 bg-white dark:bg-gray-900 min-h-screen transition-colors duration-200">
        <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div className="space-y-6">
              <h2 className="text-3xl font-semibold text-emerald-700 dark:text-emerald-400">
                Latar Belakang
              </h2>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 p-8 rounded-xl border border-emerald-100 dark:border-emerald-800 shadow-sm">
              <div className="flex items-center mb-6">
                <div className="bg-emerald-100 dark:bg-emerald-800 p-3 rounded-lg mr-4">
                  <FaTree className="text-emerald-700 dark:text-emerald-300 text-2xl" />
                </div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-start">
                    <div className="bg-emerald-100 dark:bg-emerald-800 p-1 rounded-full mr-3 mt-0.5">
